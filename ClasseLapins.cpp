...
void ClasseLapins::nombre(const long double & p_nombre) {
	m_nombre = p_nombre;
}
...
const long double ClasseLapins::nombre() const {
	return m_nombre;
}
...
long double ClasseLapins::vieillissement(long double p_nouvelEffectif) {
...
long double ClasseLapins::reproduction(unsigned p_mois) {
